	...
	real*8 bardic, dicbar, dic
      ...
      external gen_dic
    	...
    	open(unit = 6, file = 'LaborFN2_Initial.txt')
    	    	
    	open(unit = 11, file = 'LaborFN2_Output1.txt')
    	open(unit = 12, file = 'LaborFN2_Output2.txt')
    	open(unit = 13, file = 'LaborFN2_Output3.txt')
    	open(unit = 14, file = 'LaborFN2_Output4.txt')
    	open(unit = 15, file = 'LaborFN2_Output5.txt')
    	open(unit = 16, file = 'LaborFN2_Output6.txt')
    	            
    	open(unit = 21, file = 'LaborFN2_Output7.txt')
...
c     Gibbs sampler
	...
	do ir = 1, initer
          ...
          if (ir - ir/5*5 .eq. 1) then
              ...
              write(13,2) icount, delta, sigmas
...
c     Posterior estimates      
	...
	real*8 ezeta, delta, sigmas
	real*8 yystar, ddelta, ssigma
	...
	delta = ddelta
      ...
      temp = -dlog(2.d0*api*sigmas)/2.d0 
     +     - ystar**2/(2.d0*sigmas)
