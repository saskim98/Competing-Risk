	...
	real*8 bardic, dicbar, dic
      ...
      external gen_dic
    	...
    	open(unit = 6, file = 'LaborFE2_Initial.txt')
    	    	
    	open(unit = 11, file = 'LaborFE2_Output1.txt')
    	open(unit = 12, file = 'LaborFE2_Output2.txt')
    	open(unit = 13, file = 'LaborFE2_Output3.txt')
    	open(unit = 14, file = 'LaborFE2_Output4.txt')
    	open(unit = 15, file = 'LaborFE2_Output5.txt')
    	open(unit = 16, file = 'LaborFE2_Output6.txt')
    	            
    	open(unit = 21, file = 'LaborFE2_Output7.txt')
