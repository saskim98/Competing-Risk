	...
	real*8 bardic, dicbar, dic
      ...
      external gen_dic
    	...
    	open(unit = 6, file = 'LaborFS1_Initial.txt')
    	    	
    	open(unit = 11, file = 'LaborFS1_Output1.txt')
    	open(unit = 12, file = 'LaborFS1_Output2.txt')
    	open(unit = 13, file = 'LaborFS1_Output3.txt')
    	open(unit = 14, file = 'LaborFS1_Output4.txt')
    	open(unit = 15, file = 'LaborFS1_Output5.txt')
    	open(unit = 16, file = 'LaborFS1_Output6.txt')
    	            
    	open(unit = 21, file = 'LaborFS1_Output7.txt')
