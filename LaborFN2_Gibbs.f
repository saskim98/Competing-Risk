  ...
  11  do kk = 1, npoint
	...
	real*8 si, xxt(nt), xt, ystar		
      ...
      do i = 1, ni
          ...
          hmean = ystar*delta/sigmas 
          hsigma = delta**2/sigmas + 1.d0
	...
	real*8 si, xxt(nt), xt, ystar, zstar     
      real*8 suma, sumb, sumb11, sumb12, sumb2
     ...
     +            kcount, icount, numres, ifault)       
      ...
      do j1 = 1, nt
          do j2 = j1, nt
              ...
              suma = a1; sumb = b1
              sumb11 = 0.d0; sumb12 = 0.d0; sumb2 = 0.d0
              do i = 1, ni
                  ...
                  sumb11 = sumb11 + ystar*xxt(j1)
                  sumb12 = sumb12 + ystar*xxt(j2)
                  sumb2 = sumb2 + xxt(j1)*xxt(j2)
                    
              enddo      

              der2(j1,j2) = -suma*(sumb2*sumb - sumb11*sumb12) 
     +                     /sumb**2
	...
	real*8 si, xxt(nt), xt, ystar, zstar     
      ...
      summ = 0.d0
      do j = 1, nt
          summ = summ - theta(j)**2/(2.d0*sigmat)
      enddo
      
      pdf = -suma*dlog(sumb) + summ
	...
	delta = amean
      ...
      do i = 1, ni
          ...
          sumb1 = sumb1 + ystar*zstar
          sumb2 = sumb2 + ystar*zstar**2
                    
      enddo      
      asigma = -suma*(sumb2*sumb - sumb1**2)/sumb**2 
     +       - 1.d0/sigmad
	...
	real*8 si, xxt(nt), xt, ystar, zstar     
      ...
      pdf = -suma*dlog(sumb) - delta**2/(2.d0*sigmad)
