	...
	real*8 bardic, dicbar, dic
      ...
      external gen_dic
    	...
    	open(unit = 6, file = 'LaborFE1_Initial.txt')
    	    	
    	open(unit = 11, file = 'LaborFE1_Output1.txt')
    	open(unit = 12, file = 'LaborFE1_Output2.txt')
    	open(unit = 13, file = 'LaborFE1_Output3.txt')
    	open(unit = 14, file = 'LaborFE1_Output4.txt')
    	open(unit = 15, file = 'LaborFE1_Output5.txt')
    	open(unit = 16, file = 'LaborFE1_Output6.txt')
    	            
    	open(unit = 21, file = 'LaborFE1_Output7.txt')
...
c     Posterior estimates      
	...
	delta = ddelta
     ...
     +     - (v1+1.d0)/2.d0*dlog(1.d0 + ystar**2/sigmas)
      ...
      df = dexp(temp)*dexp(-zeta)

      end function	

	include 'LaborFE1_Gibbs.f'
	include 'optim1.f'
	include 'gilks2.f'
	include 'tnorm.f'
